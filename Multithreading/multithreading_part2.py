...
for num in list2: #create and start comic thread download in list2
    comicThread = threading.Thread(target= getComic, args= (num,))
    threads.append(comicThread)
    comicThread.start()

for comicThread in threads: #wait for threads to complete
    comicThread.join()
